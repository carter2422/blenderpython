...
Node_G = bpy.data.node_groups.new("Punchy Bleach", type='COMPOSITE')
...
Node_3 = Node_G.nodes.new('MIX_RGB')
Node_3.blend_type = 'OVERLAY'
...
Node_G.links.new(Node_G.outputs[0], Node_3.outputs[0])
