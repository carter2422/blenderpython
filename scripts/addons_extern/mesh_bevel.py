...
#2012-04-29 Witold Jaworski: The standard Bevel command is back, in Blender 2.63.
#                            However, in its first version it do not create bevels of equal width
#                            Fortunately, because the Bevel modifier still does it properly, this
#                            add-on still can be usable, as long as the standard Bevel is not fixed
#                            So I have just changed the name of this command displayed in the menu
#                            to Bevel (alternate)
#--- ### Imports
import bpy
...
def menu_draw(self, context):
    ...
    self.layout.operator(Bevel.bl_idname, "Bevel (alternate)")
