...
class IfcMesh(_object):
    ...
    __swig_setmethods__["normals"] = _IfcImport.IfcMesh_normals_set
    __swig_getmethods__["normals"] = _IfcImport.IfcMesh_normals_get
    if _newclass:normals = _swig_property(_IfcImport.IfcMesh_normals_get, _IfcImport.IfcMesh_normals_set)
    __swig_setmethods__["brep_data"] = _IfcImport.IfcMesh_brep_data_set
    __swig_getmethods__["brep_data"] = _IfcImport.IfcMesh_brep_data_get
    if _newclass:brep_data = _swig_property(_IfcImport.IfcMesh_brep_data_get, _IfcImport.IfcMesh_brep_data_set)
    def __init__(self): 
...
WELD_VERTICES = cvar.WELD_VERTICES
USE_WORLD_COORDS = cvar.USE_WORLD_COORDS
CONVERT_BACK_UNITS = cvar.CONVERT_BACK_UNITS
USE_BREP_DATA = cvar.USE_BREP_DATA
SEW_SHELLS = cvar.SEW_SHELLS

class IfcObject(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IfcObject, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IfcObject, name)
    __repr__ = _swig_repr
    __swig_setmethods__["id"] = _IfcImport.IfcObject_id_set
    __swig_getmethods__["id"] = _IfcImport.IfcObject_id_get
    if _newclass:id = _swig_property(_IfcImport.IfcObject_id_get, _IfcImport.IfcObject_id_set)
    __swig_setmethods__["parent_id"] = _IfcImport.IfcObject_parent_id_set
    __swig_getmethods__["parent_id"] = _IfcImport.IfcObject_parent_id_get
    if _newclass:parent_id = _swig_property(_IfcImport.IfcObject_parent_id_get, _IfcImport.IfcObject_parent_id_set)
    __swig_setmethods__["name"] = _IfcImport.IfcObject_name_set
    __swig_getmethods__["name"] = _IfcImport.IfcObject_name_get
    if _newclass:name = _swig_property(_IfcImport.IfcObject_name_get, _IfcImport.IfcObject_name_set)
    __swig_setmethods__["type"] = _IfcImport.IfcObject_type_set
    __swig_getmethods__["type"] = _IfcImport.IfcObject_type_get
    if _newclass:type = _swig_property(_IfcImport.IfcObject_type_get, _IfcImport.IfcObject_type_set)
    __swig_setmethods__["guid"] = _IfcImport.IfcObject_guid_set
    __swig_getmethods__["guid"] = _IfcImport.IfcObject_guid_get
    if _newclass:guid = _swig_property(_IfcImport.IfcObject_guid_get, _IfcImport.IfcObject_guid_set)
    __swig_setmethods__["matrix"] = _IfcImport.IfcObject_matrix_set
    __swig_getmethods__["matrix"] = _IfcImport.IfcObject_matrix_get
    if _newclass:matrix = _swig_property(_IfcImport.IfcObject_matrix_get, _IfcImport.IfcObject_matrix_set)
    def name_as_intvector(self): return _IfcImport.IfcObject_name_as_intvector(self)
    def type_as_intvector(self): return _IfcImport.IfcObject_type_as_intvector(self)
    def guid_as_intvector(self): return _IfcImport.IfcObject_guid_as_intvector(self)
    def __init__(self): 
        this = _IfcImport.new_IfcObject()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _IfcImport.delete_IfcObject
    __del__ = lambda self : None;
IfcObject_swigregister = _IfcImport.IfcObject_swigregister
IfcObject_swigregister(IfcObject)

class IfcGeomObject(IfcObject):
    __swig_setmethods__ = {}
    for _s in [IfcObject]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, IfcGeomObject, name, value)
    __swig_getmethods__ = {}
    for _s in [IfcObject]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
def InitUCS2(*args):
  return _IfcImport.InitUCS2(*args)
InitUCS2 = _IfcImport.InitUCS2

def Settings(*args):
  return _IfcImport.Settings(*args)
Settings = _IfcImport.Settings
...
def GetObject(*args):
  return _IfcImport.GetObject(*args)
GetObject = _IfcImport.GetObject

def CleanUp():
  return _IfcImport.CleanUp()
CleanUp = _IfcImport.CleanUp

def GetLog():
  return _IfcImport.GetLog()
GetLog = _IfcImport.GetLog
